...
def build_input_from_segments(persona, history, reply, tokenizer, lm_labels=False, with_eos=True):
    ...
    # print("Persona is ",tokenizer.decode(chain(*persona)))
    # print("---------------------------------------------------------------------")
    # print("History is ",tokenizer.decode(chain(*history)))
    # print("---------------------------------------------------------------------")
    # print("reply is ",tokenizer.decode(reply))
    # print("---------------------------------------------------------------------")
    ...
    # print("[sequence[0]] is ", [sequence[0]])
    # print("sequence[1:] is ", sequence[1:])
    # print("speaker 1, 2 is ", [speaker1, speaker2])
    # print([[i,s] for i, s in enumerate(sequence[1:])])
    # print("[[speaker2 if (len(sequence)-i) % 2 else speaker1] + s for i, s in enumerate(sequence[1:])] is ")
    # print([[speaker2 if (len(sequence)-i) % 2 else speaker1] + s for i, s in enumerate(sequence[1:])])
    sequence = [sequence[0]] + [[speaker2 if (len(sequence)-i) % 2 else speaker1] + s for i, s in enumerate(sequence[1:])]
    # print("sequence is ",tokenizer.decode(chain(*sequence)))
    # print("---------------------------------------------------------------------")
    instance = {}
